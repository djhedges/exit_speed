...
class TestDataLogger(unittest.TestCase):
  ...
  def testSetFilePath(self):
    ...
    logger = data_logger.Logger(prefix, proto_class=exit_speed_pb2.Gps)
  ...
  def testWriteAndReadBack(self):
    logger = data_logger.Logger(self.file_path, proto_class=exit_speed_pb2.Gps)
