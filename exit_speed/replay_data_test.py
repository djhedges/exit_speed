...
class TestReplayData(unittest.TestCase):
  ...
  @parameterized.expand([
      ...
      ('testdata/three_qual_laps_1.data', 
          {1: 93400,
           2: 91618,
           3: 90801,
           }),
      ### TODO(djhedges): Replace this data file with actual data.
      ### This file was generated by manually splitting up the points
      ### from the qualifying session to mimic the refactor.
      #('testdata/2021-03-28T10:29:1.200000_split_1.data', 
      #    {1: 93400,
      #     2: 91618,
      #     3: 90801,
      #     }),
