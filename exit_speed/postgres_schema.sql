...
CREATE TABLE ecu (
  ...
  cam_inlet_bank_1             FLOAT             NOT NULL,
  cam_inlet_bank_2             FLOAT             NOT NULL,
  cam_exhaust_bank_1           FLOAT             NOT NULL,
  cam_exhaust_bank_2           FLOAT             NOT NULL,
  lambda_1                     FLOAT             NOT NULL,
  lambda_2                     FLOAT             NOT NULL,
  trig_1_error_counter         INT               NOT NULL,
  fault_codes                  INT               NOT NULL,
  fuel_pressure                FLOAT             NOT NULL,
  oil_temp_f                   FLOAT             NOT NULL,
  oil_pressure                 FLOAT             NOT NULL,
  lf_wheel_speed               FLOAT             NOT NULL,
  lr_wheel_speed               FLOAT             NOT NULL,
  rf_wheel_speed               FLOAT             NOT NULL,
  rr_wheel_speed               FLOAT             NOT NULL,
  knock_level_1                FLOAT             NOT NULL,
  knock_level_2                FLOAT             NOT NULL,
  knock_level_3                FLOAT             NOT NULL,
  knock_level_4                FLOAT             NOT NULL,
  knock_level_5                FLOAT             NOT NULL,
  knock_level_6                FLOAT             NOT NULL,
  knock_level_7                FLOAT             NOT NULL,
  knock_level_8                FLOAT             NOT NULL,
  limits_flags                 INT               NOT NULL,
  aps_main                     FLOAT             NOT NULL,
  percent_ethanol              FLOAT             NOT NULL,
  status_bit_field             INT               NOT NULL
);
